...
def solve_instance_dynamic_pickup(csv_path, w1=5.0, w2=5.0, penalty_new_factor=2.0,
                                  ...
                                  score_slack_weight=0.0,
                                  score_emargin_weight=0.0,
                                  score_lmargin_weight=0.0):
    """
...
def run_dynamic_batch(all_sets, detail_dir_name="DynamicPickup_details_wo_RiskAwareScoring",
    ...
    for set_id, name_list in all_sets:
        ...
        for name in name_list:
            ...
            for (w1, w2) in w_pairs:
                detail_xlsx = os.path.join(detail_dir, f"Dynamic_{name}_RiskAware.xlsx")
...
DYNAMIC_OUT_XLSX = "DynamicPickup_results_wo_RiskAwareScoring.xlsx"
